...
fun Screen() {
    ...
    viewModel.primary.value = MaterialTheme.colors.primary
    val configuration = LocalConfiguration.current.orientation

    viewModel.board.forEach {
        it.color.value = viewModel.primary.value; viewModel.whichPlayerWins(it)
    }
    ...
    Scaffold(
        ...
        floatingActionButton = {
            if (viewModel.isGameStarted.value) {
                FloatingActionButton(
                    onClick = { viewModel.reset(viewModel.primary.value) }
                ) {
                    Icon(
        ...
        Content(
            ...
            softReset = { viewModel.softReset(viewModel.primary.value) },
